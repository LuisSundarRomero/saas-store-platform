...
export function CheckoutError({ whatsappNumero }: { whatsappNumero: string }) {
    ...
    <main className="min-h-screen flex flex-col items-center justify-center px-4 py-12 bg-[#1F1F22]">
      <div className="w-full max-w-sm">
        ...
        <div className="flex justify-center mb-6">
          <div className="w-20 h-20 rounded-full flex items-center justify-center" style={{ backgroundColor: '#3A1014' }}>
        ...
        {isOrderFailed && charge && (
          <div className="rounded-2xl p-5 mb-5 text-center border border-[#2C2C30]" style={{ backgroundColor: '#161618' }}>
            <p className="text-xs font-semibold text-[#FF6B7A] uppercase tracking-widest mb-1">Código de cargo</p>
            <p className="text-lg font-bold break-all" style={{ color: 'var(--color-brand)' }}>{charge}</p>
